...
# You can download this script and run it with: curl -sSLhttps://raw.githubusercontent.com/setlife-network/fedimint/v0.2.1-mainnet/docker/tls-download-mutinynet.sh | bash

DOCKER_COMPOSE_FILE=https://raw.githubusercontent.com/setlife-network/fedimint/v0.2.1-mainnet/docker/full-tls-mutinynet/docker-compose.yaml
